...
<div id="content">
    ...
    <h2 class="fonted">You are about to delete a snippet... </h2><br>

    <p class="fonted">Are you sure you want to delete the snippet "<? echo $clicked; ?>"?</p><br>

    <p class="fonted dark"><a href="delete_process.php?name=<? echo $clicked?>&bundle=<? echo $bundle; ?>">YES! Delete this bastard.</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:javascript:history.go(-1)">NO! Get me outta here!</a></p>
